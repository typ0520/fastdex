...
public class CheckUpdateDialog extends JDialog {
    ...
    public CheckUpdateDialog() {
        ...
        setTitle("Fastdex Gradle Plugin Update");
        ...
        MulLabel history = new MulLabel("<a href='#'>github.com/typ0520/fastdex/releases</a>", true);
        history.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
                Utils.openUrl("https://github.com/typ0520/fastdex/releases");
            }
        });
        updateContent.add(history);
        updateContent.add(new JTitle("Official Website"));
        MulLabel website = new MulLabel("<a href='#'>github.com/typ0520/fastdex</a>", true);
        website.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
                Utils.openUrl("https://github.com/typ0520/fastdex");
            }
        });
        updateContent.add(website);
        updateContent.add(new MulLabel("NOTE: Click update button will sync project automatically", true));
        setResizable(false);
        setLocationCenter();
