...
package com.dx168.fastdex.build.aapt;

import com.dx168.fastdex.build.aapt.RDotTxtEntry.IdType;
import com.dx168.fastdex.build.aapt.RDotTxtEntry.RType;
...
public final class AaptUtil {
    ...
    public static AaptResourceCollector collectResource(List<String> resourceDirectoryList, Map<RType, Set<RDotTxtEntry>> rTypeResourceMap) {
        ...
        List<com.dx168.fastdex.build.aapt.RDotTxtEntry> references = new ArrayList<com.dx168.fastdex.build.aapt.RDotTxtEntry>();
...
//}
     ...
     */
    public static Map<String, Map<RType, Set<com.dx168.fastdex.build.aapt.RDotTxtEntry>>> mergePackageRTypeResourceMap(List<PackageRTypeResourceMap> packageRTypeResourceMapList) {
        Map<String, Map<RType, Set<com.dx168.fastdex.build.aapt.RDotTxtEntry>>> packageRTypeResourceMergeMap = new HashMap<String, Map<RType, Set<com.dx168.fastdex.build.aapt.RDotTxtEntry>>>();
        ...
        for (PackageRTypeResourceMap packageRTypeResourceMap : packageRTypeResourceMapList) {
            ...
            Map<RType, Set<com.dx168.fastdex.build.aapt.RDotTxtEntry>> rTypeResourceMap = packageRTypeResourceMap.rTypeResourceMap;
            ...
            Iterator<Entry<RType, Set<com.dx168.fastdex.build.aapt.RDotTxtEntry>>> iterator = rTypeResourceMap.entrySet().iterator();
            while (iterator.hasNext()) {
                Entry<RType, Set<com.dx168.fastdex.build.aapt.RDotTxtEntry>> entry = iterator.next();
                RType rType = entry.getKey();
                Set<com.dx168.fastdex.build.aapt.RDotTxtEntry> rDotTxtEntrySet = entry.getValue();
                for (com.dx168.fastdex.build.aapt.RDotTxtEntry rDotTxtEntry : rDotTxtEntrySet) {
     ...
     * @param isFinal
     */
    public static void writeRJava(String outputDirectory, String packageName, Map<RType, Set<com.dx168.fastdex.build.aapt.RDotTxtEntry>> rTypeResourceMap, boolean isFinal) {
        ...
        try {
            ...
            for (RType rType : rTypeResourceMap.keySet()) {
                ...
                for (com.dx168.fastdex.build.aapt.RDotTxtEntry rDotTxtEntry : rTypeResourceMap.get(rType)) {
     ...
     * @throws IOException
     */
    public static void writeRJava(String outputDirectory, Map<String, Map<RType, Set<com.dx168.fastdex.build.aapt.RDotTxtEntry>>> packageRTypeResourceMap, boolean isFinal) {
        for (String packageName : packageRTypeResourceMap.keySet()) {
            Map<RType, Set<com.dx168.fastdex.build.aapt.RDotTxtEntry>> rTypeResourceMap = packageRTypeResourceMap.get(packageName);
    ...
    public static class PackageRTypeResourceMap {
        ...
        private Map<RType, Set<com.dx168.fastdex.build.aapt.RDotTxtEntry>> rTypeResourceMap = null;

        public PackageRTypeResourceMap(String packageName, Map<RType, Set<com.dx168.fastdex.build.aapt.RDotTxtEntry>> rTypeResourceMap) {
