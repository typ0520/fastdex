 ...
 */
public class SendInAdapter extends SmartBeanArrayAdapter<Product> {
    /**
     * 出货地址选择动作
     */
    ...
    public SendInAdapter(Context context) {
        super(context,R.layout.list_item_send_in,ViewHolder.class);
    }
