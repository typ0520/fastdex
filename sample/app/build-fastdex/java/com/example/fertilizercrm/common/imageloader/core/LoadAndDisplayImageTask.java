...
import com.example.fertilizercrm.common.imageloader.core.assist.ImageScaleType;
...
import com.example.fertilizercrm.common.imageloader.core.decode.ImageDecodingInfo;
...
import com.example.fertilizercrm.common.imageloader.utils.IoUtils;
...
final class LoadAndDisplayImageTask implements Runnable, IoUtils.CopyListener {
	...
	private boolean resizeAndSaveImage(File targetFile, int maxWidth, int maxHeight) throws IOException {
		...
		ImageDecodingInfo decodingInfo = new ImageDecodingInfo(memoryCacheKey,
				ImageDownloader.Scheme.FILE.wrap(targetFile.getAbsolutePath()), targetImageSize, ViewScaleType.FIT_INSIDE,
