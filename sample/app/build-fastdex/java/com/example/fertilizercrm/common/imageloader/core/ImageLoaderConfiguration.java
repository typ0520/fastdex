 ...
 *******************************************************************************/
package com.example.fertilizercrm.common.imageloader.core;
...
import com.example.fertilizercrm.common.imageloader.cache.disc.DiscCacheAware;
import com.example.fertilizercrm.common.imageloader.cache.disc.impl.TotalSizeLimitedDiscCache;
import com.example.fertilizercrm.common.imageloader.cache.disc.impl.UnlimitedDiscCache;
import com.example.fertilizercrm.common.imageloader.cache.disc.impl.FileCountLimitedDiscCache;
import com.example.fertilizercrm.common.imageloader.cache.disc.naming.FileNameGenerator;
import com.example.fertilizercrm.common.imageloader.cache.memory.MemoryCacheAware;
import com.example.fertilizercrm.common.imageloader.cache.memory.impl.FuzzyKeyMemoryCache;
import com.example.fertilizercrm.common.imageloader.core.assist.ImageSize;
import com.example.fertilizercrm.common.imageloader.core.assist.MemoryCacheUtil;
import com.example.fertilizercrm.common.imageloader.core.assist.QueueProcessingType;
import com.example.fertilizercrm.common.imageloader.core.decode.ImageDecoder;
import com.example.fertilizercrm.common.imageloader.core.download.ImageDownloader;
import com.example.fertilizercrm.common.imageloader.cache.memory.impl.LruMemoryCache;
import com.example.fertilizercrm.common.imageloader.core.download.NetworkDeniedImageDownloader;
import com.example.fertilizercrm.common.imageloader.core.download.SlowNetworkImageDownloader;
import com.example.fertilizercrm.common.imageloader.core.process.BitmapProcessor;
import com.example.fertilizercrm.common.imageloader.utils.L;
import com.example.fertilizercrm.common.imageloader.utils.StorageUtils;
...
public final class ImageLoaderConfiguration {
	...
	public static class Builder {
		 ...
		 * <b>NOTE:</b> If you use this method then
		 * {@link TotalSizeLimitedDiscCache TotalSizeLimitedDiscCache}
		 ...
		 * By default: disc cache is unlimited.<br />
		 * <b>NOTE:</b> If you use this method then
		 * {@link FileCountLimitedDiscCache FileCountLimitedDiscCache}
		 * will be used as disc cache. You can use {@link #discCache(DiscCacheAware)} method for introduction your own
		 * implementation of {@link DiscCacheAware}
		 */
		 ...
		 * Consider {@link L#disableLogging()} to disable ImageLoader logging completely (even error logs)
		 */
