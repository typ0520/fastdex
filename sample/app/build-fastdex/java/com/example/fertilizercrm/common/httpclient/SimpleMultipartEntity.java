...
package com.example.fertilizercrm.common.httpclient;
...
class SimpleMultipartEntity implements HttpEntity {
    ...
    private static final String boundary = "------bocop_android_httpclient------";
    private static final byte[] boundaryLine = ("--" + boundary + "\r\n").getBytes();
    private static final byte[] boundaryEnd = ("--" + boundary + "--\r\n").getBytes();
