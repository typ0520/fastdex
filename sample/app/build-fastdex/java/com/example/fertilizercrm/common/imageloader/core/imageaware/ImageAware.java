 ...
 *******************************************************************************/
package com.example.fertilizercrm.common.imageloader.core.imageaware;
...
public interface ImageAware {
	...
	/**
	 * Returns wrapped Android {@link View View}. Can return <b>null</b> if no view is wrapped.<br />
	 * Called on UI thread.
	 */
	View getWrappedView();
	 ...
	 * {@linkplain DisplayImageOptions display options}.
	 *
	 ...
	 * Called on UI thread to display loaded and decoded image {@link Bitmap} in this image view aware.
	 * Actually it's used only in
	 * {@link BitmapDisplayer BitmapDisplayer}.
	 *
